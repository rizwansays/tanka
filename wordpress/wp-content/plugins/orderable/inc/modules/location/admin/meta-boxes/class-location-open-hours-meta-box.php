...
class Orderable_Location_Open_Hours_Meta_Box {
	...
	public static function output() {
		...
		$should_show_override_open_hours_field = ! empty( $post ) && 'orderable_locations' === $post->post_type;
		...
		$override_open_hours = (bool) $data['orderable_override_open_hours'] || ! $should_show_override_open_hours_field;
