(function ($) {
  ...
  const orderable_dz = {
     ...
     * @returns void
     */
    handler_trigger_dom_update: function (event, {
     ...
     * @param {Object} request_data The data sent and the response of the request.
     */
    handler_after_dom_update: function (event, data) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_toggle_tabs: function (event) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_escape_key_close_modal: function (event) {
      if (event.key == 'Escape') {
     ...
     */
    handler_open_add_update_modal: function (event, transition_action) {
      let action;
      if (transition_action) {
        action = transition_action;
      } else {
        var $btn = $(event.target).hasClass('dashicons') ? $(event.target).parent() : $(event.target);
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_open_add_existing_modal: function (event) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_close_modal: function (event) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_add_update_zone: function (event) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_add_existing_zone: function (event) {
      orderable_dz.maybe_show_modal_spinner();
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_transition_modal: function (event) {
     ...
     * @param {Event} event jQuery Event object.
     */
    handler_remove_zone: function (event) {
     ...
     */
    handler_remove_all_time_slot_zones: function (event, data) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    handler_sanitize_fee: function (event) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    handler_zone_search: function (event) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    handler_modal_form_change: function (event) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    handler_mark_zone_selected: function (event) {
     ...
     */
    maybe_show_no_zones_msg: function () {
     ...
     */
    generate_zone_row_data: function (request, response, $time_slot_row = false) {
     ...
     * @param {Object} response Request data.
     */
    insert_delivery_zone_in_time_slot: function (request, response) {
     ...
     */
    update_delivery_zone_in_time_slot: function (request, response) {
     ...
     * @param {Object} response Response data.
     */
    remove_delivery_zone_in_time_slot: function (request, response) {
      for (let zone_id of response.data.zone_ids) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    form_add_zone_data: function (event) {
     ...
     */
    close_modal: function (event, open_add_update_modal = false) {
     ...
     */
    maybe_show_modal_spinner: function (remove = false) {
     ...
     * @param {Event} event The jQuery Event object.
     */
    hide_existing_time_slot_zones: function (event) {
      const time_slot_id = orderable_dz.get_time_slot_id(event),
     ...
     */
    unhide_existing_time_slot_zones: function () {
     ...
     * @param {Event} event The jQuery Event object.
     */
    get_time_slot_id: function (event) {
      // Service hours UI.
     ...
     * @param {Event} event The jQuery Event object.
     */
    get_time_slot_index: function (event) {
      // Service hours UI.
...
(function ($) {
  var orderable_multi_location = {
    ...
    handle_enable_service_delivery_on_click: function () {
      var delivery_is_enabled = $(this).hasClass('woocommerce-input-toggle--enabled');
      ...
      if (pickup_is_enabled && delivery_is_enabled) {
        ...
        var has_pickup_days_selected = $('.orderable-toggle-wrapper--pickup').find('.orderable-select--days').first().val().length;
    ...
    handle_enable_service_pickup_on_click: function () {
      var pickup_is_enabled = $(this).hasClass('woocommerce-input-toggle--enabled'),
    ...
    on_new_holiday_row: function () {
      var $row = $('.orderable-table--holidays').find('.orderable-table__row--repeatable:last-child');
      $row.find('.datepicker').each(function () {
        var args = $(this).data('datepicker');
