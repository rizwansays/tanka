  ...
  [6732],
  {
    ...
    16422: (e, o, t) => {
      t.r(o),
        t.d(o, {
          HelpPanel: () => f,
          SETUP_TASK_HELP_ITEMS_FILTER: () => k,
          default: () => S,
        });
      var c = t(69307),
        m = t(65736),
      ...
      const f = (e) => {
        ...
        const t = (function (e) {
                ...
                case "tax":
                  return (function (e) {
                    const { countryCode: o, taskLists: t } = e,
                      c = t
                        .reduce((e, o) => [...e, ...o.tasks], [])
                        .find((e) => "tax" === e.id);
                    if (!c) return;
                    const { additionalData: n } = c,
                      { woocommerceTaxCountries: r = [], taxJarActivated: i } =
                        n,
                      u = !i && r.includes(o);
                    return [
                      {
          ...
          return p.map((e) => {
            ...
            return {
              ...
              linkType:
                null !== (o = e.linkType) && void 0 !== o ? o : "external",
        ...
        return (0, c.createElement)(
          c.Fragment,
          null,
          (0, c.createElement)(w.Z, {
            title: (0, m.__)("Documentation", "woocommerce"),
          }),
          (0, c.createElement)(
            p.Section,
            null,
            (0, c.createElement)(p.List, {
              items: t,
