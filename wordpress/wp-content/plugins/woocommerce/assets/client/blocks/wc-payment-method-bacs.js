      ...
      561: function (e) {
        e.exports = (function () {
          ...
          var g,
            ...
            S = L(String.prototype.trim),
            _ = L(RegExp.prototype.test),
            x =
              ((g = TypeError),
              function () {
                for (
          ...
          return (function t() {
            ...
            var ae = (function (t, n) {
              ...
              pe = {};
            try {
              pe = O(i).documentMode ? i.documentMode : {};
            } catch (e) {}
            var de = {};
            o.isSupported =
              "function" == typeof re &&
            ...
            var he,
              ...
              Ae = K,
              Se = null,
              _e = k({}, [].concat(r(M), r(R), r(C), r(F), r(H))),
              xe = null,
              Le = k({}, [].concat(r(z), r(P), r(j), r(B))),
              ke = Object.seal(
                Object.create(null, {
                  tagNameCheck: {
                    writable: !0,
              ...
              mt = function (t) {
                (ct && ct === t) ||
                  ...
                  (Se = "ALLOWED_TAGS" in t ? k({}, t.ALLOWED_TAGS, ge) : _e),
                  (xe = "ALLOWED_ATTR" in t ? k({}, t.ALLOWED_ATTR, ge) : Le),
                  (at =
                    "ALLOWED_NAMESPACES" in t
                      ? k({}, t.ALLOWED_NAMESPACES, E)
                      : it),
                  (Je =
                    "ADD_URI_SAFE_ATTR" in t
                      ? k(O(Qe), t.ADD_URI_SAFE_ATTR, ge)
                      : Qe),
                  (Xe =
                    "ADD_DATA_URI_TAGS" in t
                      ? k(O(Ze), t.ADD_DATA_URI_TAGS, ge)
                      : Ze),
                  (Ke =
                    "FORBID_CONTENTS" in t ? k({}, t.FORBID_CONTENTS, ge) : Ve),
                  (Oe = "FORBID_TAGS" in t ? k({}, t.FORBID_TAGS, ge) : {}),
                  (De = "FORBID_ATTR" in t ? k({}, t.FORBID_ATTR, ge) : {}),
                  ...
                  $e &&
                    ((Se = k({}, r(H))),
                    (xe = []),
                    !0 === $e.html && (k(Se, M), k(xe, z)),
                    !0 === $e.svg && (k(Se, R), k(xe, P), k(xe, B)),
                    !0 === $e.svgFilters && (k(Se, C), k(xe, P), k(xe, B)),
                    !0 === $e.mathMl && (k(Se, F), k(xe, j), k(xe, B))),
                  t.ADD_TAGS &&
                    (Se === _e && (Se = O(Se)), k(Se, t.ADD_TAGS, ge)),
                  t.ADD_ATTR &&
                    (xe === Le && (xe = O(xe)), k(xe, t.ADD_ATTR, ge)),
                  t.ADD_URI_SAFE_ATTR && k(Je, t.ADD_URI_SAFE_ATTR, ge),
                  t.FORBID_CONTENTS &&
                    (Ke === Ve && (Ke = O(Ke)), k(Ke, t.FORBID_CONTENTS, ge)),
                  qe && (Se["#text"] = !0),
                  Ue && k(Se, ["html", "head", "body"]),
                  Se.table && (k(Se, ["tbody"]), delete Oe.tbody),
                  u && u(t),
                  (ct = t));
              },
              ft = k({}, ["mi", "mo", "mn", "ms", "mtext"]),
              pt = k({}, ["foreignobject", "desc", "title", "annotation-xml"]),
            ...
            var yt = function (e) {
              ...
              wt = function (e) {
                ...
                if (
                  ...
                  return yt(e), !0;
                if ("select" === r && _(/<template/i, e.innerHTML))
                  return yt(e), !0;
                if (!Se[r] || Oe[r]) {
                  if (!Oe[r] && St(r)) {
                    if (
                ...
                return e instanceof m &&
                  ...
                  ? (Fe &&
                      ...
                      (t = w(t, ve, " ")),
                      e.textContent !== t &&
                        (v(o.removed, { element: e.cloneNode() }),
                        (e.textContent = t))),
              ...
              At = function (e, t, n) {
                if (Ge && ("id" === t || "name" === t) && (n in i || n in st))
                  return !1;
                if (Re && !De[t] && _(Te, t));
                else if (Me && _(Ee, t));
                else if (!xe[t] || De[t]) {
                      ...
                      if (Ie || !_(/\/>/i, r)) {
                        ...
                        if (At(f, a, r)) {
                          if (
                            ...
                            ae &&
                              "object" === e(L) &&
                              "function" == typeof L.getAttributeType)
                          )
                            if (m);
                            else
                              switch (L.getAttributeType(f, a)) {
                                case "TrustedHTML":
                                  r = ae.createHTML(r);
                                  break;
              ...
              xt = function e(t) {
                ...
                for (
                  ...
                  Nt("uponSanitizeShadowNode", n, null),
                    wt(n) || (n.content instanceof l && e(n.content), _t(n));
            ...
            return (
              (o.sanitize = function (t) {
                ...
                if (
                  ...
                  (1 ===
                    (i = (r = vt("\x3c!----\x3e")).ownerDocument.importNode(
                      t,
                      !0
                    )).nodeType &&
                    "BODY" === i.nodeName) ||
                  ...
                  if (!Pe && !Fe && !Ue && -1 === t.indexOf("<"))
                    return ae && Be ? ae.createHTML(t) : t;
                  if (!(r = vt(t))) return Pe ? null : Be ? ie : "";
                }
                r && ze && yt(r.firstChild);
                for (var d = Tt(Ye ? t : r); (c = d.nextNode()); )
                  (3 === c.nodeType && c === u) ||
                    wt(c) ||
                    (c.content instanceof l && xt(c.content), _t(c), (u = c));
                if (((u = null), Ye)) return t;
                if (Pe) {
                  if (je)
                    for (m = ue.call(r.ownerDocument); r.firstChild; )
                      m.appendChild(r.firstChild);
                  else m = r;
                  return (
                    (xe.shadowroot || xe.shadowrootmod) &&
                      (m = fe.call(a, m, !0)),
                    m
                  );
                }
                ...
                return (
                  Ue &&
                    ...
                    _(Z, r.ownerDocument.doctype.name) &&
                    (h =
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      const c = ["a", "b", "em", "i", "strong", "p", "br"],
        ...
        u = window.wp.element;
      var m;
      const f = (0, o.getPaymentMethodData)("bacs", {}),
        p = (0, r.__)("Direct bank transfer", "woocommerce"),
        ...
        g = {
          ...
          label: (0, e.createElement)((t) => {
            ...
            return (0, e.createElement)(n, { text: d });
          }, null),
          ...
          supports: {
            features:
              null !== (m = null == f ? void 0 : f.supports) && void 0 !== m
                ? m
                : [],
          },
        };
