		...
		<div id="addon-editor" class="yith-wapo-addon-type-<?php echo esc_html( $addon_type ); ?>" data-addon-type="<?php echo esc_html( $addon_type ); ?>">
			...
			<?php if ( '' !== $addon_type ) :
				...
				<form action="admin.php?page=yith_wapo_panel&tab=blocks" method="post" id="addon">
                    ...
                    <input type="hidden" name="block_name" value="<?php echo ! empty( $block->get_name() ) ? $block->get_name() : ( $_REQUEST['block_name'] ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_priority" value="<?php echo ! empty( $block->get_priority() ) ? $block->get_priority() : ( $_REQUEST['block_priority'] ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
                    <input type="hidden" name="block_rule_show_in" value="<?php echo ! empty( $block->get_rule( 'show_in', '' ) ) ? $block->get_rule( 'show_in' ) : ( $_REQUEST['block_rule_show_in'] ?? '' ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended ?>">
						...
						<?php foreach ( YITH_WAPO()->get_html_types() as $key => $html_type ) : ?>
                            ...
                            $html_url = add_query_arg(
                                array(
                                    ...
                                    'block_name'     => isset( $_REQUEST['block_name'] ) && ! empty( $_REQUEST['block_name'] ) ? $_REQUEST['block_name'] : '', // phpcs:ignore WordPress.Security.NonceVerification.Recommended
